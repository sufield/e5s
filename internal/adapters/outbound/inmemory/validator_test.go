...
func TestIdentityDocumentValidator_Validate(t *testing.T) {
	...
	expected := domain.NewIdentityNamespaceFromComponents(td, "/workload")
	...
	// Mismatch namespace
	wrongNS := domain.NewIdentityNamespaceFromComponents(domain.NewTrustDomainFromName("other.org"), "/workload")
